...
class DynamicColorScheme(context: Context) : BaseColorScheme() {
...
private class MonetCompatColorScheme(context: Context, seed: Int) : BaseColorScheme() {
    ...
    override val lightScheme =
        generateColorSchemeFromSeed(context = context, seed = seed, dark = false)
    override val darkScheme =
        generateColorSchemeFromSeed(context = context, seed = seed, dark = true)
    ...
    companion object {
        ...
        private fun generateColorSchemeFromSeed(
            ...
            return ColorScheme(
                ...
                primaryContainer = dynamicColors.primaryContainer().getArgb(scheme)
                    .toComposeColor(),
                onPrimaryContainer = dynamicColors.onPrimaryContainer().getArgb(scheme)
                    .toComposeColor(),
                ...
                secondaryContainer = dynamicColors.secondaryContainer().getArgb(scheme)
                    .toComposeColor(),
                onSecondaryContainer = dynamicColors.onSecondaryContainer().getArgb(scheme)
                    .toComposeColor(),
                ...
                onTertiaryContainer = dynamicColors.onTertiaryContainer().getArgb(scheme)
                    .toComposeColor(),
                ...
                onSurfaceVariant = dynamicColors.onSurfaceVariant().getArgb(scheme)
                    .toComposeColor(),
                ...
                inverseOnSurface = dynamicColors.inverseOnSurface().getArgb(scheme)
                    .toComposeColor(),
                ...
                onErrorContainer = dynamicColors.onErrorContainer().getArgb(scheme)
                    .toComposeColor(),
                ...
                surfaceContainer = dynamicColors.surfaceContainer().getArgb(scheme)
                    .toComposeColor(),
                surfaceContainerHigh = dynamicColors.surfaceContainerHigh().getArgb(scheme)
                    .toComposeColor(),
                surfaceContainerHighest = dynamicColors.surfaceContainerHighest().getArgb(scheme)
                    .toComposeColor(),
                surfaceContainerLow = dynamicColors.surfaceContainerLow().getArgb(scheme)
                    .toComposeColor(),
                surfaceContainerLowest = dynamicColors.surfaceContainerLowest().getArgb(scheme)
                    .toComposeColor(),
            )
        }
    }

            ...
            if (it.pie.selected) {
                ...
                scope.launch {
                    it.space.animateTo(
                        ...
                        animationSpec = it.pie.spaceDegreeAnimEnterSpec
                ...
                scope.launch {
                    it.space.animateTo(
                        0f,
                        animationSpec = it.pie.spaceDegreeAnimExitSpec
    ...
    Canvas(
        ...
        details.forEachIndexed { index, detail ->
            ...
            val drawStyle = if ((detail.pie.style ?: style) is Pie.Style.Stroke) {
                Stroke(
                    width = ((detail.pie.style ?: style) as Pie.Style.Stroke).width.toPx()
                )
            } else {
                Fill
            }
            val piecePath = if (degree >= 360.0) {
                ...
                val beforeItems =
                    data.filterIndexed { filterIndex, chart -> filterIndex < index }
